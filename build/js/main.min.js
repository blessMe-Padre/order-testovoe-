...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var token = "66b9791ad59b7d04d364c17b8d9ebd2aa5ec663f"; // Инициализирует подсказки по ФИО на указанном элементе
  ...
  ;
  init($("#surname"), $("#name")); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
