    ...
    counters.forEach(function (counter) {
      counter.addEventListener('click', function (evt) {
        ...
        if (target.closest('.counter__btn')) {
          ...
          var value = parseInt(target.closest('.counter').querySelector('.count').value, 10);
          var price = target.closest('.counter').querySelector('.before').value;
          ...
          var count = target.closest('.counter').querySelector('.count').value = value;
