...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_imask__WEBPACK_IMPORTED_MODULE_6__["initImask"])(); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
    ...
    counters.forEach(function (counter) {
      counter.addEventListener('click', function (evt) {
        ...
        if (target.closest('.counter__btn')) {
          ...
          target.closest('.counter').querySelector('.counter__discount-after').value = count * discount; // карточка заказа
          ...
          productSum.innerText = Object(_modules_priceFormatter__WEBPACK_IMPORTED_MODULE_0__["default"])(totalSum); // расчет всей суммы "акции"

          var discountNew = sumDiscount - sum; // расчет финальной суммы и добавление value в скрытый инпут

          var finallyPrice = totalSum - discountNew;
          orderTotal.innerText = Object(_modules_priceFormatter__WEBPACK_IMPORTED_MODULE_0__["default"])(finallyPrice);
